...
const MyCart: React.FC = () => {
  ...
  // Extrai dados dos parâmetros de consulta com valores padrão
  const id_cart = searchParams?.get("id") || "N/A";
  const type = (searchParams?.get("type") || "Entrada") as "Entrada" | "Saída";
  const initialProducts: ProductInCart[] = [];
